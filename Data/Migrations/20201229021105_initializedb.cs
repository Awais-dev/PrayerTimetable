        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Jamat = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FajrId = table.Column<Guid>(nullable: true),
                    Sunrise = table.Column<DateTime>(nullable: false),
                    DhuhrId = table.Column<Guid>(nullable: true),
                    AsrId = table.Column<Guid>(nullable: true),
                    MaghribId = table.Column<Guid>(nullable: true),
                    IshaId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrayerTimetable", x => x.ID);
                    table.ForeignKey(
